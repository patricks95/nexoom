<?php
// Alternative VideoSDK implementation using different approach
...
<body>
    <div class="meeting-container">
        ...
        <div class="debug-info" id="debugInfo">
            <strong>VideoSDK Alternative (No videosdk.js):</strong><br>
        ...
        <!-- VideoSDK Meeting iframe - Alternative approach -->
        <iframe 
            id="meetingIframe"
    ...
    <script>
        ...
        function startMeeting() {
            try {
                console.log('Starting VideoSDK Alternative Implementation...');
                ...
                console.log('Using alternative approach to avoid videosdk.js issues');
                ...
                meetingIframe.onload = function() {
                    console.log('VideoSDK iframe loaded successfully (alternative approach)');
                    hideLoading();
                };
