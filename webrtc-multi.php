...
<body>
    ...
    <script>
        ...
        function updateParticipantList(participantList) {
            ...
            for (const [id, participant] of Object.entries(participantList)) {
                if (id !== participantId && !participants.has(id)) {
                    ...
                    addParticipantVideo(id, participant.name);
                }
            }
        ...
        function addParticipantVideo(participantId, participantName) {
            const videoGrid = document.getElementById('video-grid');
            const videoItem = document.createElement('div');
            videoItem.className = 'video-item';
            ...
            video.style.background = 'linear-gradient(135deg, #1a3d2e, #2d5a3d)';
            video.style.display = 'flex';
            video.style.alignItems = 'center';
            video.style.justifyContent = 'center';
            video.innerHTML = '<i class="fas fa-user" style="font-size: 48px; color: #d4af37;"></i>';
        }
