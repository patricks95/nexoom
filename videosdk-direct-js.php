<?php
// Direct VideoSDK JavaScript SDK implementation
...
<body>
    <div class="meeting-container">
        ...
        <div class="debug-info" id="debugInfo">
            <strong>VideoSDK Direct JS SDK:</strong><br>
        ...
        <!-- VideoSDK Meeting iframe using direct implementation -->
        <iframe 
            id="meetingIframe"
    ...
    <script>
        ...
        function startMeeting() {
            try {
                console.log('Starting VideoSDK Direct JS SDK...');
                ...
                meetingIframe.onload = function() {
                    console.log('VideoSDK Direct JS SDK iframe loaded successfully');
                    hideLoading();
                };
                
                // Set up iframe error event
                meetingIframe.onerror = function() {
                    console.error('Error loading VideoSDK Direct JS SDK iframe');
