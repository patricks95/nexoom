<?php
// Fixed VideoSDK implementation that bypasses videosdk.js issues
...
<body>
    <div class="meeting-container">
        ...
        <div class="debug-info" id="debugInfo">
            <strong>VideoSDK Fixed (No JS Library):</strong><br>
    ...
    <script>
        ...
        function startMeeting() {
            try {
                console.log('Starting VideoSDK Fixed Implementation (No videosdk.js)...');
                ...
                console.log('Using direct iframe approach to avoid videosdk.js issues');
                ...
                meetingIframe.onload = function() {
                    console.log('VideoSDK iframe loaded successfully (no videosdk.js)');
                    hideLoading();
                };
                
                // Set up iframe error event
                meetingIframe.onerror = function() {
                    console.error('Error loading VideoSDK iframe');
