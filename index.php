    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-2xl p-6 mb-8">
                ...
                <form method="GET" action="simple-meeting.php" class="flex flex-col md:flex-row gap-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 card-hover">
                    <div class="text-center">
                        ...
                        <a href="simple-meeting.php?room=demo_meeting" class="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-lg transition duration-300 inline-block">
                            Join Meeting
                        </a>
                    </div>
                </div>
