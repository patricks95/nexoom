...
<body>
    <div class="container">
        ...
        <div class="loading" id="loading">
            <i class="fas fa-spinner fa-spin"></i> Starting meeting...
        </div>
        ...
        <script>
            ...
            function startJitsiMeeting() {
                try {
                    ...
                    // Create a completely unique room name to avoid conflicts
                    const roomName = '<?php echo $meetingId; ?>' + '_' + Date.now();
                    ...
                    const options = {
                        ...
                        configOverwrite: {
                            // Completely disable all authentication and waiting features
