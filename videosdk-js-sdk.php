<?php
// VideoSDK JavaScript SDK implementation based on official documentation
...
<body>
    <div class="meeting-container">
        ...
        <div class="debug-info" id="debugInfo">
            <strong>VideoSDK JS SDK:</strong><br>
        ...
        <!-- VideoSDK Meeting iframe using correct domain -->
        <iframe 
            id="meetingIframe"
    ...
    <script>
        ...
        function startMeeting() {
            try {
                console.log('Starting VideoSDK JS SDK meeting...');
                ...
                meetingIframe.onload = function() {
                    console.log('VideoSDK JS SDK iframe loaded successfully');
                    hideLoading();
                };
                
                // Set up iframe error event
                meetingIframe.onerror = function() {
                    console.error('Error loading VideoSDK JS SDK iframe');
