<?php
// Test VideoSDK fix - no videosdk.js library
...
<head>
    ...
    <title>VideoSDK Fix Test - Nexoom</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1 class="title">VideoSDK Fix Test</h1>
        
        <div class="fix-info">
            <strong>🔧 Fix Applied:</strong><br>
            - Removed videosdk.js library that was causing "Invalid event type" error<br>
            - Using direct iframe approach to avoid JavaScript library issues<br>
            - This should resolve the videosdk.js:2:724127 error
        </div>
