<?php
// Proper VideoSDK implementation using JavaScript SDK
...
<body>
    <div class="meeting-container">
        ...
        <div class="debug-info" id="debugInfo">
            <strong>VideoSDK Proper Implementation:</strong><br>
        ...
        <!-- VideoSDK Meeting iframe using correct implementation -->
        <iframe 
            id="meetingIframe"
    ...
    <script>
        ...
        function startMeeting() {
            try {
                console.log('Starting VideoSDK Proper Implementation...');
                ...
                meetingIframe.onload = function() {
                    console.log('VideoSDK iframe loaded successfully');
                    hideLoading();
                };
