...
<body>
    ...
    <script>
        // Meeting validation and connection system
        class MeetingRoom {
            constructor() {
            ...
            async startMeeting() {
                try {
                    ...
                    this.updateStatus('Connected to meeting', 'green');
                    document.getElementById('loading').style.display = 'none';
                    this.addMessage('Successfully connected to meeting: ' + this.meetingId, 'system');
                } catch (error) {
        ...
        function startMeeting() {
            if (window.meetingRoom) {
                window.meetingRoom.startMeeting();
            }
        }
