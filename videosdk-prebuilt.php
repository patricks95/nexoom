<?php
// VideoSDK Prebuilt UI implementation based on official documentation
...
<body>
    <div class="meeting-container">
        ...
        <div class="debug-info" id="debugInfo">
            <strong>VideoSDK Prebuilt UI:</strong><br>
    ...
    <script>
        ...
        function startMeeting() {
            try {
                console.log('Starting VideoSDK Prebuilt UI meeting...');
                ...
                meetingIframe.onload = function() {
                    console.log('VideoSDK Prebuilt UI iframe loaded successfully');
                    hideLoading();
                };
                
                // Set up iframe error event
                meetingIframe.onerror = function() {
                    console.error('Error loading VideoSDK Prebuilt UI iframe');
