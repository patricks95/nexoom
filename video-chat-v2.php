...
<body>
    <div class="video-container">
        ...
        <div class="device-warning" id="deviceWarning" style="display: none;">
            <h3><i class="fas fa-exclamation-triangle"></i> Device Access Issue</h3>
            <p>It looks like your camera/microphone is already in use by another application or browser tab.</p>
            <p><strong>Solutions:</strong></p>
            <ul style="text-align: left; margin: 15px 0;">
                <li>• Close other video chat applications (Zoom, Teams, etc.)</li>
                <li>• Close other browser tabs using camera/microphone</li>
                <li>• Try refreshing this page</li>
                <li>• Use a different browser or incognito mode</li>
            </ul>
            <button onclick="retryConnection()">Try Again</button>
            <button onclick="joinWithoutVideo()">Join Without Video</button>
    ...
    <script>
        // Enhanced WebRTC-based video chat with device conflict handling
        class VideoChatV2 {
            constructor() {
            ...
            handleDeviceError(error) {
                ...
                this.updateStatus('Device Error: ' + error.message, 'red');
            }
        ...
        // Global functions for device warning buttons
        ...
        document.addEventListener('DOMContentLoaded', () => {
            window.videoChat = new VideoChatV2();
        });
    </script>
</body>
</html>
