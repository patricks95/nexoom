<?php
// Direct VideoSDK test without any authentication features
...
<body>
    <div class="container">
        <h1 class="title">Direct VideoSDK Test (No Auth)</h1>
