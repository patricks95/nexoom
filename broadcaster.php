...
<head>
    ...
    <title>Broadcaster - Nexoom</title>
...
<body class="bg-gray-900">
    <div class="video-container">
        ...
        <div class="controls fixed bottom-0 left-0 right-0 p-4 flex justify-center space-x-4">
            ...
            <button id="screen-share" class="bg-purple-600 hover:bg-purple-700 text-white p-3 rounded-full">
                <i class="fas fa-desktop"></i>
            </button>
            <button id="end-meeting" class="bg-red-600 hover:bg-red-700 text-white p-3 rounded-full">
    ...
    <script>
        const options = {
            ...
            configOverwrite: {
                ...
                toolbarButtons: ['microphone', 'camera', 'closedcaptions', 'desktop', 'recording', 'livestreaming'],
                filmstripOnly: false,
                disablePolls: false,
        ...
        document.getElementById('screen-share').onclick = function() {
            ...
            this.className = screenShareOn ? 'bg-red-600 hover:bg-red-700 text-white p-3 rounded-full' : 'bg-purple-600 hover:bg-purple-700 text-white p-3 rounded-full';
        };
